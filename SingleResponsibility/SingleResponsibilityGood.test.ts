import { EmployeeSR, Payroll } from './SingleResponsibilityGood';
import { Payment } from './SingleResponsibilityGood';
...
describe('Payroll', () => {
    ...
    it('payEmployee should log out name and net payment', async () => {
        ...
        //Assert
        expect(console.log).toHaveBeenCalledWith("test's net payment was £296 send payslip");
    });
});